...
adam solver. For the two other parameters, we narrow down our research using linspaces, with three other Grid Search CV  we get hidden layer
sizes = (168,) eg one layer of 168 neurons and alpha = 0.01444. Thereafter, we predict on the validation data left aside with this model
